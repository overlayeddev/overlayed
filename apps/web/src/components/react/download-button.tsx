...
export default function DownloadButton({
  ...
  return (
    <div
      className="fill-white hover:fill-primary ease-in-out duration-300 transition-all flex flex-col items-center justify-center gap-2 p-4 hover:bg-neutral-700 bg-neutral-800 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105"
      {...props}
    >
      <a
        target="_blank"
